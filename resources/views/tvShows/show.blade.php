...
<section class="movie-info border-b border-gray-800">
    <div class="container mx-auto px-4 py-16 flex  sm:flex-none ">
        <img src="{{ "https://image.tmdb.org/t/p/w500/".$TvShow['poster_path'] }}"
            ...
            style="width: 24rem">
        <div class="ml-24">
            <h2 class="text-4xl font-semibold text-gray-350">{{ $TvShow['name'] }}</h2>
            ...
            <div class="mt-12">
                <h4 class="text-white font-smibold">Featured Production</h4>
                <div class="flex mt-4 ">
                    ...
                    <div class="mt-4">
                        <h5>
                            @foreach ( $TvShow['production_companies'] as $companies)
                            <span>{{ $companies['name'] }}@if (!$loop->last),@endif</span>
                            @endforeach
                        </h5>
                        <h5 class="mt-2">
                            @foreach ( $TvShow['production_countries'] as $country)
            ...
            <div class="mt-12">
                <button class="flex item-center text-gray-200 rounded font-semibold px-4 py-2">
                    <a class="flex"
                        target="blank"
                        href="http://youtube.com/watch?v={{ $TvShow['videos']['results']['0']['key'] }}">
                        <svg class="mr-2"
                        ...
                        <span class="mt-2">Watch The Tailer</span>
                    </a>
                </button>
    ...
    <div class="container mx-auto px-4 pt-16">
        <div class="movie-cast">
            ...
            <div class="grid xs:grid-cols-1 justify-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
                ...
                @foreach ($TvShow['credits']['cast'] as $cast)@if ($loop->index < 5)
                    <div
                    class="mt-8">
                    <a href="#">
    ...
    <div class="container mx-auto px-4 pt-12 mb-12">
        <div class="movie-cast">
            ...
            <div class="grid xs:grid-cols-1 justify-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-8">
                ...
                @foreach ($TvShow['images']['backdrops'] as $poster)
                @if ($loop->index < 18)
                    <div
                    class="mt-8">
                    <a href="#">
